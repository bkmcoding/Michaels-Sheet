...
> = {
  "data-structures": {
    ...
    cheatsheets: [
      ...
      {
        id: "9",
        title: "Coursera - Data Structures Specialization",
        type: "external",
            ...
            {classInfo.cheatsheets.map((sheet) => (
              <div key={sheet.id} className="group bg-background p-8 transition-colors hover:bg-muted">
                <div className="flex flex-col gap-4">
                  ...
                  {sheet.type === "pdf" && (
                    <button className="mt-2 inline-flex items-center gap-2 text-sm text-foreground underline transition-colors hover:text-muted-foreground">
                      View PDF
                      <ArrowRight className="h-3 w-3" />
                    </button>
                  )}
